...
def weighted_transp(pulse, time_t, gpw_fpath, ksd_fpath, pulse_rho_dpath,
    ...
    from rhoanalysis.wtransp import WTPCalculator
    ...
    b = WTPCalculator(time_t,pulse,gpw_fpath,ksd_fpath,pulse_rho_dpath)
...
if __name__ == '__main__':
    ...
    weighted_transp(pulse,time_t,args.gpw_fpath,args.ksd_fpath,args.pulse_rho_dpath,
