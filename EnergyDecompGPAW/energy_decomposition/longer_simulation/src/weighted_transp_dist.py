...
def weighted_transp_dist(pulse,time_t,gpw_fpath,ksd_fpath,pulse_rho_dpath,
                 ofpath,transitions,occ_weight_fpath,unocc_weight_fpath):
    from rhoanalysis.base import BaseCalculator, build_filter
    from rhoanalysis.transp import TransPCalculator
    from rhoanalysis.wtransp_dist import WTPDistCalculator
    ...
    weights_wfs=ks_weights(occ_weight_fpath, unocc_weight_fpath, imin, imax, amin, amax)
    ...
    b = WTPDistCalculator(time_t,pulse,gpw_fpath,ksd_fpath,pulse_rho_dpath)
    b.run(energy_o,energy_u,sigma,weights_wfs,P_ia,outfpath=ofpath,flt=flt3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('occ_weight_fpath', type=FilePathType)
    parser.add_argument('unocc_weight_fpath', type=FilePathType)
    ...
    weighted_transp_dist(pulse,time_t,args.gpw_fpath,args.ksd_fpath,args.pulse_rho_dpath,
                 args.out_fpath,args.transitions,args.occ_weight_fpath,args.unocc_weight_fpath)
